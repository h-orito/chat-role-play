 ...
 * Integer repliedCount = entity.getRepliedCount();
 * Integer favoredCount = entity.getFavoredCount();
 ...
 * entity.setRepliedCount(repliedCount);
 * entity.setFavoredCount(favoredCount);
 ...
 */
public abstract class DbBsMessage extends AbstractEntity implements DomainEntity, DbEntityDefinedCommonColumn {
    ...
    protected Integer _repliedCount;

    /** favored_count: {NotNull, INT UNSIGNED(10)} */
    protected Integer _favoredCount;
     ...
     */
    public void uniqueBy(Integer gameId, String messageTypeCode, Integer messageNumber) {
        ...
        setGameId(gameId);setMessageTypeCode(messageTypeCode);setMessageNumber(messageNumber);
    }
    ...
    protected List<DbMessageReply> _messageReplyByFromMessageIdList;

    /**
     * [get] MESSAGE_REPLY by from_message_id, named 'messageReplyByFromMessageIdList'.
     * @return The entity list of referrer property 'messageReplyByFromMessageIdList'. (NotNull: even if no loading, returns empty list)
     */
    public List<DbMessageReply> getMessageReplyByFromMessageIdList() {
        if (_messageReplyByFromMessageIdList == null) { _messageReplyByFromMessageIdList = newReferrerList(); }
        return _messageReplyByFromMessageIdList;
    }

    /**
     * [set] MESSAGE_REPLY by from_message_id, named 'messageReplyByFromMessageIdList'.
     * @param messageReplyByFromMessageIdList The entity list of referrer property 'messageReplyByFromMessageIdList'. (NullAllowed)
     */
    public void setMessageReplyByFromMessageIdList(List<DbMessageReply> messageReplyByFromMessageIdList) {
        _messageReplyByFromMessageIdList = messageReplyByFromMessageIdList;
    }

    /** MESSAGE_REPLY by reply_message_id, named 'messageReplyByReplyMessageIdList'. */
    protected List<DbMessageReply> _messageReplyByReplyMessageIdList;

    /**
     * [get] MESSAGE_REPLY by reply_message_id, named 'messageReplyByReplyMessageIdList'.
     * @return The entity list of referrer property 'messageReplyByReplyMessageIdList'. (NotNull: even if no loading, returns empty list)
     */
    public List<DbMessageReply> getMessageReplyByReplyMessageIdList() {
        if (_messageReplyByReplyMessageIdList == null) { _messageReplyByReplyMessageIdList = newReferrerList(); }
        return _messageReplyByReplyMessageIdList;
    }

    /**
     * [set] MESSAGE_REPLY by reply_message_id, named 'messageReplyByReplyMessageIdList'.
     * @param messageReplyByReplyMessageIdList The entity list of referrer property 'messageReplyByReplyMessageIdList'. (NullAllowed)
     */
    public void setMessageReplyByReplyMessageIdList(List<DbMessageReply> messageReplyByReplyMessageIdList) {
        _messageReplyByReplyMessageIdList = messageReplyByReplyMessageIdList;
    }
    ...
    /**
     * [get] MESSAGE_FAVORITE by message_id, named 'messageFavoriteList'.
    ...
    /**
     * [set] MESSAGE_FAVORITE by message_id, named 'messageFavoriteList'.
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof DbBsMessage) {
            DbBsMessage other = (DbBsMessage)obj;
    ...
    protected String doBuildStringWithRelation(String li) {
        ...
        if (_messageReplyByFromMessageIdList != null) { for (DbMessageReply et : _messageReplyByFromMessageIdList)
        { if (et != null) { sb.append(li).append(xbRDS(et, "messageReplyByFromMessageIdList")); } } }
        if (_messageReplyByReplyMessageIdList != null) { for (DbMessageReply et : _messageReplyByReplyMessageIdList)
        { if (et != null) { sb.append(li).append(xbRDS(et, "messageReplyByReplyMessageIdList")); } } }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_repliedCount));
        sb.append(dm).append(xfND(_favoredCount));
    ...
    protected String doBuildRelationString(String dm) {
        ...
        if (_messageReplyByFromMessageIdList != null && !_messageReplyByFromMessageIdList.isEmpty())
        { sb.append(dm).append("messageReplyByFromMessageIdList"); }
        if (_messageReplyByReplyMessageIdList != null && !_messageReplyByReplyMessageIdList.isEmpty())
        { sb.append(dm).append("messageReplyByReplyMessageIdList"); }
    ...
    /**
     * [get] message_type_code: {+UQ, NotNull, VARCHAR(255)} <br>
    ...
    /**
     * [set] message_type_code: {+UQ, NotNull, VARCHAR(255)} <br>
    ...
    /**
     * [get] replied_count: {NotNull, INT UNSIGNED(10)} <br>
     * @return The value of the column 'replied_count'. (basically NotNull if selected: for the constraint)
     */
    public Integer getRepliedCount() {
        checkSpecifiedProperty("repliedCount");
        return _repliedCount;
    }

    /**
     * [set] replied_count: {NotNull, INT UNSIGNED(10)} <br>
     * @param repliedCount The value of the column 'replied_count'. (basically NotNull if update: for the constraint)
     */
    public void setRepliedCount(Integer repliedCount) {
        registerModifiedProperty("repliedCount");
        _repliedCount = repliedCount;
    }

    /**
     * [get] favored_count: {NotNull, INT UNSIGNED(10)} <br>
     * @return The value of the column 'favored_count'. (basically NotNull if selected: for the constraint)
     */
    public Integer getFavoredCount() {
        checkSpecifiedProperty("favoredCount");
        return _favoredCount;
    }

    /**
     * [set] favored_count: {NotNull, INT UNSIGNED(10)} <br>
     * @param favoredCount The value of the column 'favored_count'. (basically NotNull if update: for the constraint)
     */
    public void setFavoredCount(Integer favoredCount) {
        registerModifiedProperty("favoredCount");
        _favoredCount = favoredCount;
    }
