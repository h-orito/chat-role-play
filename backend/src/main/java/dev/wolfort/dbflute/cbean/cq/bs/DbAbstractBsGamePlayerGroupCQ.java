...
/**
 * The abstract condition-query of game_player_group.
 * @author DBFlute(AutoGenerator)
 */
public abstract class DbAbstractBsGamePlayerGroupCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public DbAbstractBsGamePlayerGroupCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * {exists (select game_player_group_id from direct_message where ...)} <br>
     * direct_message by game_player_group_id, named 'directMessageAsOne'.
     * <pre>
    ...
    public void existsDirectMessage(SubQuery<DbDirectMessageCB> subCBLambda) {
        ...
        lockCall(() -> subCBLambda.query(cb)); String pp = keepGamePlayerGroupId_ExistsReferrer_DirectMessageList(cb.query());
        registerExistsReferrer(cb.query(), "game_player_group_id", "game_player_group_id", pp, "directMessageList");
    }
    public abstract String keepGamePlayerGroupId_ExistsReferrer_DirectMessageList(DbDirectMessageCQ sq);

    /**
     * Set up NotExistsReferrer (correlated sub-query). <br>
     * {not exists (select game_player_group_id from direct_message where ...)} <br>
     * direct_message by game_player_group_id, named 'directMessageAsOne'.
     * <pre>
     ...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of GamePlayerGroupId_NotExistsReferrer_DirectMessageList for 'not exists'. (NotNull)
     */
    public void notExistsDirectMessage(SubQuery<DbDirectMessageCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        DbDirectMessageCB cb = new DbDirectMessageCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepGamePlayerGroupId_NotExistsReferrer_DirectMessageList(cb.query());
        registerNotExistsReferrer(cb.query(), "game_player_group_id", "game_player_group_id", pp, "directMessageList");
    }
    public abstract String keepGamePlayerGroupId_NotExistsReferrer_DirectMessageList(DbDirectMessageCQ sq);
    ...
    public void xsderiveDirectMessageList(String fn, SubQuery<DbDirectMessageCB> sq, String al, DerivedReferrerOption op) {
        ...
        lockCall(() -> sq.query(cb)); String pp = keepGamePlayerGroupId_SpecifyDerivedReferrer_DirectMessageList(cb.query());
        registerSpecifyDerivedReferrer(fn, cb.query(), "game_player_group_id", "game_player_group_id", pp, "directMessageList", al, op);
    }
    public abstract String keepGamePlayerGroupId_SpecifyDerivedReferrer_DirectMessageList(DbDirectMessageCQ sq);
    ...
    public void xqderiveDirectMessageList(String fn, SubQuery<DbDirectMessageCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        DbDirectMessageCB cb = new DbDirectMessageCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String sqpp = keepGamePlayerGroupId_QueryDerivedReferrer_DirectMessageList(cb.query()); String prpp = keepGamePlayerGroupId_QueryDerivedReferrer_DirectMessageListParameter(vl);
        registerQueryDerivedReferrer(fn, cb.query(), "game_player_group_id", "game_player_group_id", sqpp, "directMessageList", rd, vl, prpp, op);
    }
    public abstract String keepGamePlayerGroupId_QueryDerivedReferrer_DirectMessageList(DbDirectMessageCQ sq);
    public abstract String keepGamePlayerGroupId_QueryDerivedReferrer_DirectMessageListParameter(Object vl);

    /**
     * IsNull {is null}. And OnlyOnceRegistered. <br>
     * game_player_group_id: {PK, ID, NotNull, INT UNSIGNED(10)}
     */
    public void setGamePlayerGroupId_IsNull() { regGamePlayerGroupId(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * game_player_group_id: {PK, ID, NotNull, INT UNSIGNED(10)}
     */
    public void setGamePlayerGroupId_IsNotNull() { regGamePlayerGroupId(CK_ISNN, DOBJ); }
     ...
     */
    public HpSLCFunction<DbGamePlayerGroupCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, DbGamePlayerGroupCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<DbGamePlayerGroupCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, DbGamePlayerGroupCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<DbGamePlayerGroupCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, DbGamePlayerGroupCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<DbGamePlayerGroupCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, DbGamePlayerGroupCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<DbGamePlayerGroupCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, DbGamePlayerGroupCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;DbGamePlayerGroupCB&gt;() {
     *     public void query(DbGamePlayerGroupCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<DbGamePlayerGroupCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, DbGamePlayerGroupCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        DbGamePlayerGroupCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(DbGamePlayerGroupCQ sq);

    protected DbGamePlayerGroupCB xcreateScalarConditionCB() {
        DbGamePlayerGroupCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected DbGamePlayerGroupCB xcreateScalarConditionPartitionByCB() {
        DbGamePlayerGroupCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<DbGamePlayerGroupCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        DbGamePlayerGroupCB cb = new DbGamePlayerGroupCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "game_player_group_id";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(DbGamePlayerGroupCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<DbGamePlayerGroupCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(DbGamePlayerGroupCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        DbGamePlayerGroupCB cb = new DbGamePlayerGroupCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "game_player_group_id";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(DbGamePlayerGroupCQ sq);
     ...
     */
    public void myselfExists(SubQuery<DbGamePlayerGroupCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        DbGamePlayerGroupCB cb = new DbGamePlayerGroupCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(DbGamePlayerGroupCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected DbGamePlayerGroupCB newMyCB() {
        return new DbGamePlayerGroupCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return DbGamePlayerGroupCQ.class.getName(); }
