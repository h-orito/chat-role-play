 ...
 */
public class DbBsCharaImageCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected DbCharaImageCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public DbBsCharaImageCB() {
     ...
     * @return this. (NotNull)
     */
    public DbCharaImageCB acceptPK(Integer charaImageId) {
        assertObjectNotNull("charaImageId", charaImageId);
        DbBsCharaImageCB cb = this;
        cb.query().setCharaImageId_Equal(charaImageId);
        return (DbCharaImageCB)this;
    }

    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_CharaImageId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_CharaImageId_Desc();
        return this;
    }
     ...
     */
    public DbCharaImageCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public DbCharaImageCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected DbCharaImageCQ doGetConditionQuery() {
    ...
    protected DbCharaImageCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected DbCharaImageCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        DbCharaImageCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected DbCharaImageCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new DbCharaImageCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<DbCharaImageCB> unionCBLambda) {
        final DbCharaImageCB cb = new DbCharaImageCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final DbCharaImageCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<DbCharaImageCB> unionCBLambda) {
        final DbCharaImageCB cb = new DbCharaImageCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final DbCharaImageCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">charaImageBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">charaImage</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">charaImage</span>.<span style="color: #CC4747">getChara()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
    ...
    public static class HpSpecification extends HpAbstractSpecification<DbCharaImageCQ> {
        protected DbCharaCB.HpSpecification _chara;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<DbCharaImageCQ> qyCall
         ...
         */
        public SpecifiedColumn columnCharaImageId() { return doColumn("chara_image_id"); }
        /**
         ...
         */
        public HpSDRFunction<DbCharaImageCB, DbCharaImageCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<DbCharaImageCB> sq, DbCharaImageCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public DbCharaImageCB dreamCruiseCB() {
        DbCharaImageCB cb = new DbCharaImageCB();
        cb.xsetupForDreamCruise((DbCharaImageCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<DbCharaImageCB> columnQuery(final SpecifyQuery<DbCharaImageCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected DbCharaImageCB xcreateColumnQueryCB() {
        DbCharaImageCB cb = new DbCharaImageCB();
        cb.xsetupForColumnQuery((DbCharaImageCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<DbCharaImageCB> orCBLambda) {
        xorSQ((DbCharaImageCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<DbCharaImageCB> andCBLambda) {
        xorSQAP((DbCharaImageCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final DbCharaImageCB cb;
        if (mainCB != null) {
            cb = (DbCharaImageCB)mainCB;
        } else {
            cb = new DbCharaImageCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return DbCharaImageCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return DbCharaImageCQ.class.getName(); }
