...
import dev.wolfort.dbflute.cbean.cq.bs.DbBsDesignerCQ;
 ...
 */
public class DbDesignerCQ extends DbBsDesignerCQ {
     ...
     */
    public DbDesignerCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
