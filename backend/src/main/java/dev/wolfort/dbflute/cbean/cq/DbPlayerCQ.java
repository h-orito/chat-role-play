...
import dev.wolfort.dbflute.cbean.cq.bs.DbBsPlayerCQ;
 ...
 */
public class DbPlayerCQ extends DbBsPlayerCQ {
     ...
     */
    public DbPlayerCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
