...
import dev.wolfort.dbflute.cbean.cq.bs.DbBsCharaCQ;
 ...
 */
public class DbCharaCQ extends DbBsCharaCQ {
     ...
     */
    public DbCharaCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
