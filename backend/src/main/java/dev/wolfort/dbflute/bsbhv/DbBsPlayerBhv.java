 ...
 */
public abstract class DbBsPlayerBhv extends AbstractBehaviorWritable<DbPlayer, DbPlayerCB> {
    ...
    //                                                                             =======
    /** {@inheritDoc} */
    public DbPlayerDbm asDBMeta() { return DbPlayerDbm.getInstance(); }
    /** {@inheritDoc} */
    ...
    //                                                                        ============
    /** {@inheritDoc} */
    public DbPlayerCB newConditionBean() { return new DbPlayerCB(); }
     ...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of DbPlayer. (NotNull)
     * @return The count for the condition. (NotMinus)
     */
    public int selectCount(CBCall<DbPlayerCB> cbLambda) {
     ...
     */
    public OptionalEntity<DbPlayer> selectEntity(CBCall<DbPlayerCB> cbLambda) {
        return facadeSelectEntity(createCB(cbLambda));
    }

    protected OptionalEntity<DbPlayer> facadeSelectEntity(DbPlayerCB cb) {
        return doSelectOptionalEntity(cb, typeOfSelectedEntity());
    }

    protected <ENTITY extends DbPlayer> OptionalEntity<ENTITY> doSelectOptionalEntity(DbPlayerCB cb, Class<? extends ENTITY> tp) {
     ...
     * <pre>
     * DbPlayer <span style="color: #553000">player</span> = <span style="color: #0000C0">playerBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> cb.acceptPK(1));
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public DbPlayer selectEntityWithDeletedCheck(CBCall<DbPlayerCB> cbLambda) {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<DbPlayer> selectByPK(Integer playerId) {
        return facadeSelectByPK(playerId);
    }

    protected OptionalEntity<DbPlayer> facadeSelectByPK(Integer playerId) {
        return doSelectOptionalByPK(playerId, typeOfSelectedEntity());
    }

    protected <ENTITY extends DbPlayer> ENTITY doSelectByPK(Integer playerId, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(playerId), tp);
    }

    protected <ENTITY extends DbPlayer> OptionalEntity<ENTITY> doSelectOptionalByPK(Integer playerId, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectByPK(playerId, tp), playerId);
    }

    protected DbPlayerCB xprepareCBAsPK(Integer playerId) {
     ...
     * <pre>
     * ListResultBean&lt;DbPlayer&gt; <span style="color: #553000">playerList</span> = <span style="color: #0000C0">playerBhv</span>.<span style="color: #CC4747">selectList</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...;
     *     <span style="color: #553000">cb</span>.query().addOrderBy...;
     * });
     * <span style="color: #70226C">for</span> (DbPlayer <span style="color: #553000">player</span> : <span style="color: #553000">playerList</span>) {
     *     ... = <span style="color: #553000">player</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of DbPlayer. (NotNull)
     ...
     */
    public ListResultBean<DbPlayer> selectList(CBCall<DbPlayerCB> cbLambda) {
     ...
     * <pre>
     * PagingResultBean&lt;DbPlayer&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">playerBhv</span>.<span style="color: #CC4747">selectPage</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     *     <span style="color: #553000">cb</span>.query().addOrderBy...
     ...
     * ...
     * <span style="color: #70226C">for</span> (DbPlayer player : <span style="color: #553000">page</span>) {
     *     ... = player.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of DbPlayer. (NotNull)
     ...
     * @throws DangerousResultSizeException When the result size is over the specified safety size.
     */
    public PagingResultBean<DbPlayer> selectPage(CBCall<DbPlayerCB> cbLambda) {
     ...
     * </pre>
     * @param cbLambda The callback for condition-bean of DbPlayer. (NotNull)
     * @param entityLambda The handler of entity row of DbPlayer. (NotNull)
     */
    public void selectCursor(CBCall<DbPlayerCB> cbLambda, EntityRowHandler<DbPlayer> entityLambda) {
     ...
     */
    public <RESULT> HpSLSFunction<DbPlayerCB, RESULT> selectScalar(Class<RESULT> resultType) {
     ...
     */
    public void load(List<DbPlayer> playerList, ReferrerLoaderHandler<DbLoaderOfPlayer> loaderLambda) {
        xassLRArg(playerList, loaderLambda);
        loaderLambda.handle(new DbLoaderOfPlayer().ready(playerList, _behaviorSelector));
    }
     ...
     * @param loaderLambda The callback to handle the referrer loader for actually loading referrer. (NotNull)
     */
    public void load(DbPlayer player, ReferrerLoaderHandler<DbLoaderOfPlayer> loaderLambda) {
        xassLRArg(player, loaderLambda);
        loaderLambda.handle(new DbLoaderOfPlayer().ready(xnewLRAryLs(player), _behaviorSelector));
    }
     ...
     * <pre>
     * <span style="color: #0000C0">playerBhv</span>.<span style="color: #CC4747">loadGamePlayer</span>(<span style="color: #553000">playerList</span>, <span style="color: #553000">playerCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * <span style="color: #70226C">for</span> (DbPlayer player : <span style="color: #553000">playerList</span>) {
     ...
     */
    public NestedReferrerListGateway<DbGamePlayer> loadGamePlayer(List<DbPlayer> playerList, ReferrerConditionSetupper<DbGamePlayerCB> refCBLambda) {
        xassLRArg(playerList, refCBLambda);
        return doLoadGamePlayer(playerList, new LoadReferrerOption<DbGamePlayerCB, DbGamePlayer>().xinit(refCBLambda));
    }
     ...
     * GAME_PLAYER by player_id, named 'gamePlayerList'.
     * <pre>
     * <span style="color: #0000C0">playerBhv</span>.<span style="color: #CC4747">loadGamePlayer</span>(<span style="color: #553000">player</span>, <span style="color: #553000">playerCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">playerCB</span>.setupSelect...
     *     <span style="color: #553000">playerCB</span>.query().set...
     *     <span style="color: #553000">playerCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">player</span>.<span style="color: #CC4747">getGamePlayerList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<DbGamePlayer> loadGamePlayer(DbPlayer player, ReferrerConditionSetupper<DbGamePlayerCB> refCBLambda) {
        xassLRArg(player, refCBLambda);
        return doLoadGamePlayer(xnewLRLs(player), new LoadReferrerOption<DbGamePlayerCB, DbGamePlayer>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<DbGamePlayer> doLoadGamePlayer(List<DbPlayer> playerList, LoadReferrerOption<DbGamePlayerCB, DbGamePlayer> option) {
        return helpLoadReferrerInternally(playerList, option, "gamePlayerList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">playerBhv</span>.<span style="color: #CC4747">loadPlayerAuthority</span>(<span style="color: #553000">playerList</span>, <span style="color: #553000">authorityCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<DbPlayerAuthority> loadPlayerAuthority(List<DbPlayer> playerList, ReferrerConditionSetupper<DbPlayerAuthorityCB> refCBLambda) {
        xassLRArg(playerList, refCBLambda);
        return doLoadPlayerAuthority(playerList, new LoadReferrerOption<DbPlayerAuthorityCB, DbPlayerAuthority>().xinit(refCBLambda));
    }
     ...
     * PLAYER_AUTHORITY by player_id, named 'playerAuthorityList'.
     * <pre>
     * <span style="color: #0000C0">playerBhv</span>.<span style="color: #CC4747">loadPlayerAuthority</span>(<span style="color: #553000">player</span>, <span style="color: #553000">authorityCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">authorityCB</span>.setupSelect...
     *     <span style="color: #553000">authorityCB</span>.query().set...
     *     <span style="color: #553000">authorityCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">player</span>.<span style="color: #CC4747">getPlayerAuthorityList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<DbPlayerAuthority> loadPlayerAuthority(DbPlayer player, ReferrerConditionSetupper<DbPlayerAuthorityCB> refCBLambda) {
        xassLRArg(player, refCBLambda);
        return doLoadPlayerAuthority(xnewLRLs(player), new LoadReferrerOption<DbPlayerAuthorityCB, DbPlayerAuthority>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<DbPlayerAuthority> doLoadPlayerAuthority(List<DbPlayer> playerList, LoadReferrerOption<DbPlayerAuthorityCB, DbPlayerAuthority> option) {
        return helpLoadReferrerInternally(playerList, option, "playerAuthorityList");
    }
    ...
    //                                                                   =================
    /**
     * Pull out the list of referrer-as-one table 'DbPlayerAccount'.
     * @param playerList The list of player. (NotNull, EmptyAllowed)
     * @return The list of referrer-as-one table. (NotNull, EmptyAllowed, NotNullElement)
     */
    public List<DbPlayerAccount> pulloutPlayerAccountAsOne(List<DbPlayer> playerList)
    { return helpPulloutInternally(playerList, "playerAccountAsOne"); }
     ...
     */
    public List<Integer> extractPlayerIdList(List<DbPlayer> playerList)
     ...
     * <pre>
     * DbPlayer player = <span style="color: #70226C">new</span> DbPlayer();
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void insertOrUpdate(DbPlayer player) {
     ...
     */
    public int[] batchInsert(List<DbPlayer> playerList) {
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchUpdate(List<DbPlayer> playerList) {
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchDelete(List<DbPlayer> playerList) {
     ...
     * <pre>
     * <span style="color: #0000C0">playerBhv</span>.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;DbPlayer, DbPlayerCB&gt;() {
     *     public ConditionBean setup(DbPlayer entity, DbPlayerCB intoCB) {
     *         FooCB cb = FooCB();
     *         cb.setupSelect_Bar();
     *
     ...
     */
    public int queryInsert(QueryInsertSetupper<DbPlayer, DbPlayerCB> manyArgLambda) {
     ...
     */
    public int queryUpdate(DbPlayer player, CBCall<DbPlayerCB> cbLambda) {
     ...
     */
    public int queryDelete(CBCall<DbPlayerCB> cbLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(DbPlayer player, WritableOptionCall<DbPlayerCB, InsertOption<DbPlayerCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(DbPlayer player, WritableOptionCall<DbPlayerCB, UpdateOption<DbPlayerCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(DbPlayer player, WritableOptionCall<DbPlayerCB, InsertOption<DbPlayerCB>> insertOpLambda, WritableOptionCall<DbPlayerCB, UpdateOption<DbPlayerCB>> updateOpLambda) {
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(DbPlayer player, WritableOptionCall<DbPlayerCB, DeleteOption<DbPlayerCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<DbPlayer> playerList, WritableOptionCall<DbPlayerCB, InsertOption<DbPlayerCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<DbPlayer> playerList, WritableOptionCall<DbPlayerCB, UpdateOption<DbPlayerCB>> opLambda) {
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<DbPlayer> playerList, WritableOptionCall<DbPlayerCB, DeleteOption<DbPlayerCB>> opLambda) {
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<DbPlayer, DbPlayerCB> manyArgLambda, WritableOptionCall<DbPlayerCB, InsertOption<DbPlayerCB>> opLambda) {
     ...
     */
    public int varyingQueryUpdate(DbPlayer player, CBCall<DbPlayerCB> cbLambda, WritableOptionCall<DbPlayerCB, UpdateOption<DbPlayerCB>> opLambda) {
     ...
     */
    public int varyingQueryDelete(CBCall<DbPlayerCB> cbLambda, WritableOptionCall<DbPlayerCB, DeleteOption<DbPlayerCB>> opLambda) {
     ...
     */
    public OutsideSqlAllFacadeExecutor<DbPlayerBhv> outsideSql() {
        return doOutsideSql();
    }
    ...
    //                                                                         Type Helper
    //                                                                         ===========
    protected Class<? extends DbPlayer> typeOfSelectedEntity() { return DbPlayer.class; }
    protected Class<DbPlayer> typeOfHandlingEntity() { return DbPlayer.class; }
    protected Class<DbPlayerCB> typeOfHandlingConditionBean() { return DbPlayerCB.class; }
