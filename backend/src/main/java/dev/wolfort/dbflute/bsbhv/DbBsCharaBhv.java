 ...
 */
public abstract class DbBsCharaBhv extends AbstractBehaviorWritable<DbChara, DbCharaCB> {
    ...
    //                                                                             =======
    /** {@inheritDoc} */
    public DbCharaDbm asDBMeta() { return DbCharaDbm.getInstance(); }
    /** {@inheritDoc} */
    ...
    //                                                                        ============
    /** {@inheritDoc} */
    public DbCharaCB newConditionBean() { return new DbCharaCB(); }
     ...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of DbChara. (NotNull)
     * @return The count for the condition. (NotMinus)
     */
    public int selectCount(CBCall<DbCharaCB> cbLambda) {
     ...
     */
    public OptionalEntity<DbChara> selectEntity(CBCall<DbCharaCB> cbLambda) {
        return facadeSelectEntity(createCB(cbLambda));
    }

    protected OptionalEntity<DbChara> facadeSelectEntity(DbCharaCB cb) {
        return doSelectOptionalEntity(cb, typeOfSelectedEntity());
    }

    protected <ENTITY extends DbChara> OptionalEntity<ENTITY> doSelectOptionalEntity(DbCharaCB cb, Class<? extends ENTITY> tp) {
     ...
     * <pre>
     * DbChara <span style="color: #553000">chara</span> = <span style="color: #0000C0">charaBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> cb.acceptPK(1));
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public DbChara selectEntityWithDeletedCheck(CBCall<DbCharaCB> cbLambda) {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<DbChara> selectByPK(Integer charaId) {
        return facadeSelectByPK(charaId);
    }

    protected OptionalEntity<DbChara> facadeSelectByPK(Integer charaId) {
        return doSelectOptionalByPK(charaId, typeOfSelectedEntity());
    }

    protected <ENTITY extends DbChara> ENTITY doSelectByPK(Integer charaId, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(charaId), tp);
    }

    protected <ENTITY extends DbChara> OptionalEntity<ENTITY> doSelectOptionalByPK(Integer charaId, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectByPK(charaId, tp), charaId);
    }

    protected DbCharaCB xprepareCBAsPK(Integer charaId) {
     ...
     * <pre>
     * ListResultBean&lt;DbChara&gt; <span style="color: #553000">charaList</span> = <span style="color: #0000C0">charaBhv</span>.<span style="color: #CC4747">selectList</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...;
     *     <span style="color: #553000">cb</span>.query().addOrderBy...;
     * });
     * <span style="color: #70226C">for</span> (DbChara <span style="color: #553000">chara</span> : <span style="color: #553000">charaList</span>) {
     *     ... = <span style="color: #553000">chara</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of DbChara. (NotNull)
     ...
     */
    public ListResultBean<DbChara> selectList(CBCall<DbCharaCB> cbLambda) {
     ...
     * <pre>
     * PagingResultBean&lt;DbChara&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">charaBhv</span>.<span style="color: #CC4747">selectPage</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     *     <span style="color: #553000">cb</span>.query().addOrderBy...
     ...
     * ...
     * <span style="color: #70226C">for</span> (DbChara chara : <span style="color: #553000">page</span>) {
     *     ... = chara.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of DbChara. (NotNull)
     ...
     * @throws DangerousResultSizeException When the result size is over the specified safety size.
     */
    public PagingResultBean<DbChara> selectPage(CBCall<DbCharaCB> cbLambda) {
     ...
     * </pre>
     * @param cbLambda The callback for condition-bean of DbChara. (NotNull)
     * @param entityLambda The handler of entity row of DbChara. (NotNull)
     */
    public void selectCursor(CBCall<DbCharaCB> cbLambda, EntityRowHandler<DbChara> entityLambda) {
     ...
     */
    public <RESULT> HpSLSFunction<DbCharaCB, RESULT> selectScalar(Class<RESULT> resultType) {
     ...
     */
    public void load(List<DbChara> charaList, ReferrerLoaderHandler<DbLoaderOfChara> loaderLambda) {
        xassLRArg(charaList, loaderLambda);
        loaderLambda.handle(new DbLoaderOfChara().ready(charaList, _behaviorSelector));
    }
     ...
     * @param loaderLambda The callback to handle the referrer loader for actually loading referrer. (NotNull)
     */
    public void load(DbChara chara, ReferrerLoaderHandler<DbLoaderOfChara> loaderLambda) {
        xassLRArg(chara, loaderLambda);
        loaderLambda.handle(new DbLoaderOfChara().ready(xnewLRAryLs(chara), _behaviorSelector));
    }
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * <span style="color: #70226C">for</span> (DbChara chara : <span style="color: #553000">charaList</span>) {
     ...
     */
    public NestedReferrerListGateway<DbCharaImage> loadCharaImage(List<DbChara> charaList, ReferrerConditionSetupper<DbCharaImageCB> refCBLambda) {
        xassLRArg(charaList, refCBLambda);
        return doLoadCharaImage(charaList, new LoadReferrerOption<DbCharaImageCB, DbCharaImage>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<DbCharaImage> loadCharaImage(DbChara chara, ReferrerConditionSetupper<DbCharaImageCB> refCBLambda) {
        xassLRArg(chara, refCBLambda);
        return doLoadCharaImage(xnewLRLs(chara), new LoadReferrerOption<DbCharaImageCB, DbCharaImage>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<DbCharaImage> doLoadCharaImage(List<DbChara> charaList, LoadReferrerOption<DbCharaImageCB, DbCharaImage> option) {
     ...
     * <pre>
     * <span style="color: #0000C0">charaBhv</span>.<span style="color: #CC4747">loadGamePlayer</span>(<span style="color: #553000">charaList</span>, <span style="color: #553000">playerCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<DbGamePlayer> loadGamePlayer(List<DbChara> charaList, ReferrerConditionSetupper<DbGamePlayerCB> refCBLambda) {
        xassLRArg(charaList, refCBLambda);
        return doLoadGamePlayer(charaList, new LoadReferrerOption<DbGamePlayerCB, DbGamePlayer>().xinit(refCBLambda));
    }
     ...
     * GAME_PLAYER by chara_id, named 'gamePlayerList'.
     * <pre>
     * <span style="color: #0000C0">charaBhv</span>.<span style="color: #CC4747">loadGamePlayer</span>(<span style="color: #553000">chara</span>, <span style="color: #553000">playerCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">playerCB</span>.setupSelect...
     *     <span style="color: #553000">playerCB</span>.query().set...
     *     <span style="color: #553000">playerCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">chara</span>.<span style="color: #CC4747">getGamePlayerList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<DbGamePlayer> loadGamePlayer(DbChara chara, ReferrerConditionSetupper<DbGamePlayerCB> refCBLambda) {
        xassLRArg(chara, refCBLambda);
        return doLoadGamePlayer(xnewLRLs(chara), new LoadReferrerOption<DbGamePlayerCB, DbGamePlayer>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<DbGamePlayer> doLoadGamePlayer(List<DbChara> charaList, LoadReferrerOption<DbGamePlayerCB, DbGamePlayer> option) {
        return helpLoadReferrerInternally(charaList, option, "gamePlayerList");
    }
    ...
    //                                                                   =================
    /**
     * Pull out the list of foreign table 'DbCharachip'.
     * @param charaList The list of chara. (NotNull, EmptyAllowed)
     * @return The list of foreign table. (NotNull, EmptyAllowed, NotNullElement)
     */
    public List<DbCharachip> pulloutCharachip(List<DbChara> charaList)
    { return helpPulloutInternally(charaList, "charachip"); }
     ...
     */
    public List<Integer> extractCharaIdList(List<DbChara> charaList)
     ...
     * <pre>
     * DbChara chara = <span style="color: #70226C">new</span> DbChara();
     ...
     */
    public void insert(DbChara chara) {
        doInsert(chara, null);
    }
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void update(DbChara chara) {
        doUpdate(chara, null);
    }
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void insertOrUpdate(DbChara chara) {
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void delete(DbChara chara) {
        doDelete(chara, null);
    }
     ...
     */
    public int[] batchInsert(List<DbChara> charaList) {
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchUpdate(List<DbChara> charaList) {
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchDelete(List<DbChara> charaList) {
     ...
     * <pre>
     * <span style="color: #0000C0">charaBhv</span>.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;DbChara, DbCharaCB&gt;() {
     *     public ConditionBean setup(DbChara entity, DbCharaCB intoCB) {
     *         FooCB cb = FooCB();
     *         cb.setupSelect_Bar();
     *
     ...
     */
    public int queryInsert(QueryInsertSetupper<DbChara, DbCharaCB> manyArgLambda) {
     ...
     */
    public int queryUpdate(DbChara chara, CBCall<DbCharaCB> cbLambda) {
     ...
     */
    public int queryDelete(CBCall<DbCharaCB> cbLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(DbChara chara, WritableOptionCall<DbCharaCB, InsertOption<DbCharaCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(DbChara chara, WritableOptionCall<DbCharaCB, UpdateOption<DbCharaCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(DbChara chara, WritableOptionCall<DbCharaCB, InsertOption<DbCharaCB>> insertOpLambda, WritableOptionCall<DbCharaCB, UpdateOption<DbCharaCB>> updateOpLambda) {
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(DbChara chara, WritableOptionCall<DbCharaCB, DeleteOption<DbCharaCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<DbChara> charaList, WritableOptionCall<DbCharaCB, InsertOption<DbCharaCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<DbChara> charaList, WritableOptionCall<DbCharaCB, UpdateOption<DbCharaCB>> opLambda) {
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<DbChara> charaList, WritableOptionCall<DbCharaCB, DeleteOption<DbCharaCB>> opLambda) {
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<DbChara, DbCharaCB> manyArgLambda, WritableOptionCall<DbCharaCB, InsertOption<DbCharaCB>> opLambda) {
     ...
     */
    public int varyingQueryUpdate(DbChara chara, CBCall<DbCharaCB> cbLambda, WritableOptionCall<DbCharaCB, UpdateOption<DbCharaCB>> opLambda) {
     ...
     */
    public int varyingQueryDelete(CBCall<DbCharaCB> cbLambda, WritableOptionCall<DbCharaCB, DeleteOption<DbCharaCB>> opLambda) {
     ...
     */
    public OutsideSqlAllFacadeExecutor<DbCharaBhv> outsideSql() {
        return doOutsideSql();
    }
    ...
    //                                                                         Type Helper
    //                                                                         ===========
    protected Class<? extends DbChara> typeOfSelectedEntity() { return DbChara.class; }
    protected Class<DbChara> typeOfHandlingEntity() { return DbChara.class; }
    protected Class<DbCharaCB> typeOfHandlingConditionBean() { return DbCharaCB.class; }
