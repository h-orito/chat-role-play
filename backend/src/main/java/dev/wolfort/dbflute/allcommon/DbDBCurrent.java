 ...
 */
public class DbDBCurrent {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    /** The logger instance for this class. (NotNull) */
    private static final Logger _log = LoggerFactory.getLogger(DbDBCurrent.class);

    /** Singleton instance. */
    private static final DbDBCurrent _instance = new DbDBCurrent();

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected final String _projectName = "chatrpdb";
    protected final String _projectPrefix = "Db";
     ...
     */
    public static DbDBCurrent getInstance() {
        return _instance;
    }
