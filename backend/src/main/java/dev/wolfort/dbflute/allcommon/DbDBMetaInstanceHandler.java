 ...
 */
public class DbDBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("chara", "dev.wolfort.dbflute.bsentity.dbmeta.DbCharaDbm");
        tmpMap.put("chara_image", "dev.wolfort.dbflute.bsentity.dbmeta.DbCharaImageDbm");
        tmpMap.put("charachip", "dev.wolfort.dbflute.bsentity.dbmeta.DbCharachipDbm");
        tmpMap.put("designer", "dev.wolfort.dbflute.bsentity.dbmeta.DbDesignerDbm");
        tmpMap.put("direct_message", "dev.wolfort.dbflute.bsentity.dbmeta.DbDirectMessageDbm");
        tmpMap.put("game", "dev.wolfort.dbflute.bsentity.dbmeta.DbGameDbm");
        tmpMap.put("game_period", "dev.wolfort.dbflute.bsentity.dbmeta.DbGamePeriodDbm");
        tmpMap.put("game_player", "dev.wolfort.dbflute.bsentity.dbmeta.DbGamePlayerDbm");
        tmpMap.put("game_player_group", "dev.wolfort.dbflute.bsentity.dbmeta.DbGamePlayerGroupDbm");
        tmpMap.put("game_player_group_rel", "dev.wolfort.dbflute.bsentity.dbmeta.DbGamePlayerGroupRelDbm");
        tmpMap.put("game_setting", "dev.wolfort.dbflute.bsentity.dbmeta.DbGameSettingDbm");
        tmpMap.put("message", "dev.wolfort.dbflute.bsentity.dbmeta.DbMessageDbm");
        tmpMap.put("message_favorite", "dev.wolfort.dbflute.bsentity.dbmeta.DbMessageFavoriteDbm");
        tmpMap.put("message_reply", "dev.wolfort.dbflute.bsentity.dbmeta.DbMessageReplyDbm");
        tmpMap.put("player", "dev.wolfort.dbflute.bsentity.dbmeta.DbPlayerDbm");
        tmpMap.put("player_account", "dev.wolfort.dbflute.bsentity.dbmeta.DbPlayerAccountDbm");
        tmpMap.put("player_authority", "dev.wolfort.dbflute.bsentity.dbmeta.DbPlayerAuthorityDbm");
    ...
    //                                                                  Provider Singleton
    //                                                                  ==================
    protected static final DBMetaProvider _provider = new DbDBMetaInstanceHandler();
